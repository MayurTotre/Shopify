...
class ProductsAdapter(private val productsList: ProductsResponse, private val onClickDoAction: OnClickDoAction): RecyclerView.Adapter<ProductsAdapter.ProductsViewHolder>(){
